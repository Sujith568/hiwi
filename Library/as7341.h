...
as7341_status as7341_transmitMeasurementsFIFO(uint16_t *buffer);     // Transmits readings from AS back to MSP and updates spectralData array, channels are selected through the writeSMUXmapping
...
as7341_status as7341_readRegister(uint32_t *reg);		//read a register
