...
void RadioInit( RadioEvents_t *events )
{
    ...
    SX126xSetTxParams( 0, RADIO_RAMP_800_US );
...
//		SX126xWriteRegister( REG_LR_SYNCWORD, ( 0x3455 >> 8 ) & 0xFF );
//        SX126xWriteRegister( REG_LR_SYNCWORD + 1, 0x3455 & 0xFF );	this was from johannes, dunno why
    }
    else
    {
        // Change LoRa modem SyncWord
