...
#define AM_TM_SECONDS_IN_1DAY							84640000U	//seconds in 1 day in ticks (*100)
#define AM_TM_SECONDS_IN_1HOUR							360000U		//seconds in 1 hour in ticks (*100)
#define AM_TM_SECONDS_IN_1MINUTE						6000U		//seconds in 1 minute in ticks (*100)
